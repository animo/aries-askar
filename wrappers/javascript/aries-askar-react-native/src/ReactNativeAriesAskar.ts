...
export class ReactNativeAriesAskar implements AriesAskar {
  ...
  public entryListCount(options: EntryListCountOptions): number {
    ...
    return handleError(ariesAskarReactNative.entryListCount(serializedOptions))
  }

  public entryListFree(options: EntryListFreeOptions): void {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.entryListFree(serializedOptions))
  }

  public entryListGetCategory(options: EntryListGetCategoryOptions): string {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.entryListGetCategory(serializedOptions))
  }

  public entryListGetName(options: EntryListGetNameOptions): string {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.entryListGetName(serializedOptions))
  }
  ...
  public entryListGetValue(options: EntryListGetValueOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.entryListGetValue(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyAeadDecrypt(options: KeyAeadDecryptOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyAeadDecrypt(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyAeadEncrypt(options: KeyAeadEncryptOptions): EncryptedBuffer {
    const serializedOptions = serializeArguments(options)
    const { buffer, noncePos, tagPos } = handleError(ariesAskarReactNative.keyAeadEncrypt(serializedOptions))
  ...
  public keyAeadGetPadding(options: KeyAeadGetPaddingOptions): number {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.keyAeadGetPadding(serializedOptions))
  }

  public keyAeadGetParams(options: KeyAeadGetParamsOptions): AeadParams {
    const serializedOptions = serializeArguments(options)
    const { tagLength, nonceLength } = handleError(ariesAskarReactNative.keyAeadGetParams(serializedOptions))
  ...
  public keyAeadRandomNonce(options: KeyAeadRandomNonceOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyAeadRandomNonce(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyConvert(options: KeyConvertOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyConvert(serializedOptions))
  ...
  public keyCryptoBox(options: KeyCryptoBoxOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyCryptoBox(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyCryptoBoxOpen(options: KeyCryptoBoxOpenOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyCryptoBoxOpen(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyCryptoBoxRandomNonce(): Uint8Array {
    const buf = handleError(ariesAskarReactNative.keyCryptoBoxRandomNonce({}))
    return new Uint8Array(buf)
  }

  public keyCryptoBoxSeal(options: KeyCryptoBoxSealOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyCryptoBoxSeal(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyCryptoBoxSealOpen(options: KeyCryptoBoxSealOpenOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyCryptoBoxSealOpen(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyDeriveEcdh1pu(options: KeyDeriveEcdh1puOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyDeriveEcdh1pu(serializedOptions))
    return new LocalKeyHandle(handle)
  }

  public keyDeriveEcdhEs(options: KeyDeriveEcdhEsOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyDeriveEcdhEs(serializedOptions))
    return new LocalKeyHandle(handle)
  }

  public keyEntryListCount(options: KeyEntryListCountOptions): number {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.keyEntryListCount(serializedOptions))
  }
  ...
  public keyEntryListGetAlgorithm(options: KeyEntryListGetAlgorithmOptions): string {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.keyEntryListGetAlgorithm(serializedOptions))
  }
  ...
  public keyEntryListGetName(options: KeyEntryListGetNameOptions): string {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.keyEntryListGetName(serializedOptions))
  }
  ...
  public keyEntryListLoadLocal(options: KeyEntryListLoadLocalOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyEntryListLoadLocal(serializedOptions))
  ...
  public keyFromJwk(options: KeyFromJwkOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyFromJwk(serializedOptions))
  ...
  public keyFromKeyExchange(options: KeyFromKeyExchangeOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyFromKeyExchange(serializedOptions))
  ...
  public keyFromPublicBytes(options: KeyFromPublicBytesOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyFromPublicBytes(serializedOptions))
  ...
  public keyFromSecretBytes(options: KeyFromSecretBytesOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyFromSecretBytes(serializedOptions))
  ...
  public keyFromSeed(options: KeyFromSeedOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyFromSeed(serializedOptions))
  ...
  public keyGenerate(options: KeyGenerateOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyGenerate(serializedOptions))
  ...
  public keyGetAlgorithm(options: KeyGetAlgorithmOptions): string {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.keyGetAlgorithm(serializedOptions))
  }

  public keyGetEphemeral(options: KeyGetEphemeralOptions): number {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.keyGetEphemeral(serializedOptions))
  }

  public keyGetJwkPublic(options: KeyGetJwkPublicOptions): string {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.keyGetJwkPublic(serializedOptions))
  }

  public keyGetJwkSecret(options: KeyGetJwkSecretOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyGetJwkSecret(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyGetJwkThumbprint(options: KeyGetJwkThumbprintOptions): string {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.keyGetJwkThumbprint(serializedOptions))
  }

  public keyGetPublicBytes(options: KeyGetPublicBytesOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyGetPublicBytes(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyGetSecretBytes(options: KeyGetSecretBytesOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keyGetSecretBytes(serializedOptions))
    return new Uint8Array(buf)
  }

  public keySignMessage(options: KeySignMessageOptions): Uint8Array {
    const serializedOptions = serializeArguments(options)
    const buf = handleError(ariesAskarReactNative.keySignMessage(serializedOptions))
    return new Uint8Array(buf)
  }

  public keyUnwrapKey(options: KeyUnwrapKeyOptions): LocalKeyHandle {
    const serializedOptions = serializeArguments(options)
    const handle = handleError(ariesAskarReactNative.keyUnwrapKey(serializedOptions))
  ...
  public keyWrapKey(options: KeyWrapKeyOptions): EncryptedBuffer {
    const serializedOptions = serializeArguments(options)
    const { buffer, noncePos, tagPos } = handleError(ariesAskarReactNative.keyWrapKey(serializedOptions))
  ...
  public storeGenerateRawKey(options: StoreGenerateRawKeyOptions): string {
    const serializedOptions = serializeArguments(options)
    return handleError(ariesAskarReactNative.storeGenerateRawKey(serializedOptions))
  }
